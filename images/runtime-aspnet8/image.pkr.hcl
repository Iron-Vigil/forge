...
source "docker" "runtime_aspnet8" {
  ...
  changes = [
    ...
    "LABEL org.opencontainers.image.title=runtime-aspnet8",
...
build {
  sources = ["source.docker.runtime_aspnet8"]
  ...
  post-processor "docker-tag" {
    repository = "${var.registry}/runtime-aspnet8"
