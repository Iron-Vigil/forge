#!/bin/sh
# Component: dotnet-runtime8 — .NET 8 base runtime (console/worker apps)
...
require_root
log "component/dotnet-runtime8: installing"

# The runtime package drags in its native deps (icu-libs, libssl3, libstdc++,
# lttng-ust, ...) so globalization works out of the box — no invariant mode.
...
apk_install "dotnet8-runtime=8.0.27-r0"
